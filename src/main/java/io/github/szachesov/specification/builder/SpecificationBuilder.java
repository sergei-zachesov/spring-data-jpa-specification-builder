...
/**
 * <a href="https://en.wikipedia.org/wiki/SQL_syntax#Operators">SQL operators</a>
 */
@NoArgsConstructor(staticName = "builder")
public class SpecificationBuilder<S> {

    private final List<AbstractSpecification<S, ?>> specifications = new ArrayList<>();
    ...
    // inner predicate
    public SpecificationBuilder<S> inner(AbstractSpecification<S, ?> spec) {
    ...
    public <T extends Comparable<? super T>> SpecificationBuilder<S> between(
            String column, T min, T max) {
        return between(column, min, max, ComparisonSpecification.Builder::self);
    }
    ...
    public <T extends Comparable<? super T>> SpecificationBuilder<S> between(
            List<String> columns, T min, T max) {
    ...
    public <T extends Comparable<? super T>> SpecificationBuilder<S> between(
        ...
        List<ComparisonSpecification<S, T>> comparisonSpecifications =
                ComparisonSpecification.buildListOf(builder);

        specifications.addAll(comparisonSpecifications);
    ...
    public SpecificationBuilder<S> isNotNull(String column) {
        return isNull(column, true, AbstractSpecification.Builder::not);
    }
